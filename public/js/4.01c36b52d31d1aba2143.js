...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-69f6661d", Component.options)
  } else {
    hotAPI.reload("data-v-69f6661d", Component.options)
  }
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-26b517d7", Component.options)
  } else {
    hotAPI.reload("data-v-26b517d7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var _vueMultiselect = __webpack_require__(210);
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      ...
      this.$http[method](url, this.user).then(function (response) {
        ...
        _this3.$router.push({ name: 'dashboard.user' });
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-26b517d7", module.exports)
  }
}
...
var _Form = __webpack_require__(376);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-69f6661d", module.exports)
  }
}
